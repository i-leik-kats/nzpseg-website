    ...
    <div className="page-enter">
      ...
      <div style={{ padding: "28px 0 0", display: "flex", justifyContent: "center" }}>
        ...
        >
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/nzpseg.uoa/" target="_blank" rel="noreferrer"
            style={{ color: "var(--muted)", display: "flex", transition: "color 150ms" }}
          ...
          {/* Facebook */}
          <a href="https://www.facebook.com/profile.php?id=61585237265256" target="_blank" rel="noreferrer"
            style={{ color: "var(--muted)", display: "flex", transition: "color 150ms" }}
            onMouseEnter={(e) => (e.currentTarget.style.color = "var(--ink)")}
            onMouseLeave={(e) => (e.currentTarget.style.color = "var(--muted)")}
          >
