    ...
    <div className="page-enter">
      ...
      <section style={{ padding: "72px 0 96px", position: "relative", overflow: "hidden" }}>
        <div className="container">
          ...
          {/* Social bar — sits directly above the upcoming event column */}
          <div
            style={{
              display: "flex",
              alignItems: "center",
          ...
          >
            <span className="eyebrow eyebrow-dot" style={{ margin: 0 }}>Follow us</span>
            <a
              href="https://www.instagram.com/nzpseg.uoa/"
              target="_blank"
              rel="noreferrer"
              style={{ display: "flex", alignItems: "center", gap: 7, color: "var(--muted)", textDecoration: "none", fontFamily: "var(--mono)", fontSize: 11, letterSpacing: "0.07em", textTransform: "uppercase", transition: "color 150ms" }}
            ...
            <span
              style={{ marginLeft: "auto", fontFamily: "var(--mono)", fontSize: 11, color: "var(--muted-2)", letterSpacing: "0.07em" }}
            >
              @nzpseg.uoa
            </span>
          </div>
